...
public class ConfaelTest {
   ...
   static void registerDriver() {
    ...
    void test_1() throws InterruptedException {
        ...
        Assertions.assertTrue(driver.getCurrentUrl().contains("AUTH&USER_LOGIN=nmu1989%40gmail.com"));    // проверка значения
       //* //div[@class='popmechanic-close'*// - иногда появляется реклама, мешающая авторизации
    }
